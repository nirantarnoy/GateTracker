      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">
           <div>
        <?= Html::a('<i class="fa fa-plus-circle"></i> Create Category', ['create'], ['class' => 'btn btn-success']) ?>
                        ...
                        'value' => function($model){
                                return '
                                    <div class="btn-group" >
                                        ...
                                        <li><a onclick="return confirm(\'Confirm ?\')" href="'.Url::to(['/icategory/delete', 'id'=>$model->id],true).'">Delete</a></li>
                                        </ul>
                                    </div>
                                ';
                            // }
